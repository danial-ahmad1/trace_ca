...
# Create a command-line argument for folder_loc
parser = argparse.ArgumentParser(description='RunCAP for CA Analysis')
parser.add_argument('-f', '--expname', required=True, help='Name of the folder to be analyzed')
